    ...
    <v-card class="mx-auto" max-width="800px" elevation="3">
      ...
      <v-card-text v-if="loading" class="text-center py-8">
        <v-progress-circular
          ...
          size="64"
        ></v-progress-circular>
        <div class="mt-4">Cargando datos del comensal...</div>
      </v-card-text>
...
onMounted(async () => {
  ...
  try {
    ...
    snackbarText.value = 'Error al cargar los datos del comensal';
...
const handleActualizar = async () => {
  ...
  try {
    ...
    snackbarText.value = 'Comensal actualizado exitosamente';
    ...
    snackbarText.value = 'Error al actualizar el comensal';
    snackbarColor.value = 'error';
    showSnackbar.value = true;
